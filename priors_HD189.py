...
def make_prior(args):
    ...
    prior_list = [
        # priors_atm.SimplexUniformT_Priors(kappa_min=-5.0, kappa_max=-2.0, gamma_min=-2.0,gamma_max=2.0,T_int_min=100.0,T_int_max=300.0, \
    # T_eq_min=500.0,T_eq_max=2500.0),
        priors_atm.SimplexUniformAbund_Priors(H2O_min=-8.0, H2O_max=-2.0),
    # , CO2_min=-8.0, CO2_max=-2.0,CO_min=-8.0, CO_max=-2.0),
        priors_atm.SimplexUniformTransit_Priors(Kp_min=0,Kp_max=300,Vsys_min=-20.0,Vsys_max=20.0)
