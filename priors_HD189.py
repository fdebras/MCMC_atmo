...
def make_prior(args):
    ...
    prior_list = [
        priors_atm.SimplexUniformT_Priors(T_eq_min=200.0,T_eq_max=2500.0),#kappa_min=-5.0, kappa_max=-2.0, gamma_min=-2.0,gamma_max=2.0,T_int_min=100.0,T_int_max=300.0, \
    # T_eq_min=800.0,T_eq_max=1500.0),
        priors_atm.SimplexUniformAbund_Priors(H2O_min=-8.0, H2O_max=0.0,CO_min=-8.0, CO_max=0.0),
